...
class TopsisController extends Controller
{
    public function index(Request $request)
    {
        ...
        $jmlK1 = kriteria::where('kode', 'K1')->count();
        $jmlK2 = kriteria::where('kode', 'K2')->count();
        $jmlK3 = kriteria::where('kode', 'K3')->count();
        $jmlK4 = kriteria::where('kode', 'K4')->count();
        $jmlK5 = kriteria::where('kode', 'K5')->count();
        ...
        foreach ($dataGuru as $key => $value) {
            ...
            foreach ($dataResponden as $key2 => $value2) {
                if ($value->id == $value2->guru_id) {
                    $totResGuru = responden::where('guru_id', $value->id)->count();

                    // $allK1 = responden::where(function ($query) use ($value) {
                    ...
                    // $allK2 = responden::where(function ($query) use ($value) {
                    //     $query->where('guru_id', $value->id)
                    //         ->whereHas('getKriteria', function ($query) {
                    //             $query->where('kode', 'K2');
                    //         });
                    ...
                    // $allK3 = responden::where(function ($query) use ($value) {
                    //     $query->where('guru_id', $value->id)
                    //         ->whereHas('getKriteria', function ($query) {
                    //             $query->where('kode', 'K3');
                    //         });
                    ...
                    // $allK4 = responden::where(function ($query) use ($value) {
                    //     $query->where('guru_id', $value->id)
                    //         ->whereHas('getKriteria', function ($query) {
                    //             $query->where('kode', 'K4');
                    //         });
                    ...
                    // $allK5 = responden::where(function ($query) use ($value) {
                    //     $query->where('guru_id', $value->id)
                    //         ->whereHas('getKriteria', function ($query) {
                    //             $query->where('kode', 'K5');
                    //         });
                    ...
                    $totResGuruK1 = responden::where(function ($query) use ($value) {
                        $query->where('guru_id', $value->id)
                            ->whereHas('getKriteria', function ($query) {
                                $query->where('kode', 'K1');
                            });
                    ...
                    $totResGuruK2 = responden::where(function ($query) use ($value) {
                        $query->where('guru_id', $value->id)
                            ->whereHas('getKriteria', function ($query) {
                                $query->where('kode', 'K2');
                            });
                    ...
                    $totResGuruK3 = responden::where(function ($query) use ($value) {
                        $query->where('guru_id', $value->id)
                            ->whereHas('getKriteria', function ($query) {
                                $query->where('kode', 'K3');
                            });
                    ...
                    $totResGuruK4 = responden::where(function ($query) use ($value) {
                        $query->where('guru_id', $value->id)
                            ->whereHas('getKriteria', function ($query) {
                                $query->where('kode', 'K4');
                            });
                    ...
                    $totResGuruK5 = responden::where(function ($query) use ($value) {
                        $query->where('guru_id', $value->id)
                            ->whereHas('getKriteria', function ($query) {
                                $query->where('kode', 'K5');
                            });
                    ...
                    $sumK1 = responden::where(function ($query) use ($value) {
                        $query->where('guru_id', $value->id)
                            ->whereHas('getKriteria', function ($query) {
                                $query->where('kode', 'K1');
                            });
                    ...
                    $sumK2 = responden::where(function ($query) use ($value) {
                        $query->where('guru_id', $value->id)
                            ->whereHas('getKriteria', function ($query) {
                                $query->where('kode', 'K2');
                            });
                    ...
                    $sumK3 = responden::where(function ($query) use ($value) {
                        $query->where('guru_id', $value->id)
                            ->whereHas('getKriteria', function ($query) {
                                $query->where('kode', 'K3');
                            });
                    ...
                    $sumK4 = responden::where(function ($query) use ($value) {
                        $query->where('guru_id', $value->id)
                            ->whereHas('getKriteria', function ($query) {
                                $query->where('kode', 'K4');
                            });
                    ...
                    $sumK5 = responden::where(function ($query) use ($value) {
                        $query->where('guru_id', $value->id)
                            ->whereHas('getKriteria', function ($query) {
                                $query->where('kode', 'K5');
                            });
