                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="app-brand d-flex justify-content-center align-items-center">
                            <img src="{{ asset('sneat-1.0.0/assets/img/logo.jpeg') }}" width="20%" alt="Brand Logo"
                                class="img-fluid" />
                        </div>
                        <!-- /Logo -->
                        ...
                        <form id="formAuthentication" class="mb-3" action="{{ route('authLoginSiswa') }}" method="POST">
                            @csrf
                            <div class="mb-3">
                                <label for="nim" class="form-label"> NIM</label>
                                <input type="text" class="form-control" id="nim" name="nim"
                                    placeholder="Enter your nim" autofocus />
                            </div>
